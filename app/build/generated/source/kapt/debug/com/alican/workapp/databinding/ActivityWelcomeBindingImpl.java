...
public class ActivityWelcomeBindingImpl extends ActivityWelcomeBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.txtWelcome, 1);
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.alican.workapp.ui.main.welcome.WelcomeViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.alican.workapp.ui.main.welcome.WelcomeViewModel ViewModel) {
