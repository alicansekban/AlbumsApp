...
public abstract class Hilt_AlbumDetailFragment<VM extends BaseViewModel, DB extends ViewDataBinding> extends BaseFragment<VM, DB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_AlbumDetailFragment(Class<VM> mViewModelClass) {
